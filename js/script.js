...
var docReady = function docReady(fn) {
  // See If DOM Is Already Avaliable
...
// Top Navigation Bar On Scroll Opacity
var navbarInit = function navbarInit() {
  ...
  if (navbar) {
    ...
    var _window$getComputedSt = window.getComputedStyle(navbar), backgroundImage = _window$getComputedSt.backgroundImage;
    var transition = 'background-color 0.35s ease';
    
    // Change Top Navgation Bar Background Color On Scroll
    ...
    // Toggle Background Class On Window Resize
